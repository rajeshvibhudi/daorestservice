...
public class HelloWorldWebAppTest extends JerseyTest {
    ...
    public HelloWorldWebAppTest() throws Exception {
        super(new WebAppDescriptor.Builder("com.sun.jersey.samples.helloworld.resources")
                .contextPath("daorestserviceapp").build());
    }
    ...
    public void testGetEmployees() throws Exception {
        ...
        String responseMsg = webResource.path("EmployeeService/GetEmployees").get(String.class);
    ...
    public void testRetriveEmployee() throws Exception {
        WebResource webResource = resource();
        String responseMsg = webResource.path("EmployeeService/getemployee").get(String.class);
        System.out.println(responseMsg);
      // Assert.assertEquals("Hello World", responseMsg);
    }
    @Test
    public void testUpdateEmployee() throws Exception {
        WebResource webResource = resource();
        String responseMsg = webResource.path("EmployeeService/updateemployee").get(String.class);
        System.out.println(responseMsg);
      // Assert.assertEquals("Hello World", responseMsg);
    }
    @Test
    public void testDeleteEmployee() throws Exception {
        WebResource webResource = resource();
        String responseMsg = webResource.path("EmployeeService/deleteemployee").get(String.class);
        System.out.println(responseMsg);
      // Assert.assertEquals("Hello World", responseMsg);
    }
    @Test
